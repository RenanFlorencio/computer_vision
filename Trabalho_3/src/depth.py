...
class DepthEstimator:
    ...
    def add_calibration_point(self, depth_value, real_distance_meters):
        ...
        self.calibration_points.append((float(depth_value), float(real_distance_meters)))
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            cv2.line(frame, (center[0]-40, center[1]), (center[0]+40, center[1]), (0, 255, 0), 3)
            cv2.line(frame, (center[0], center[1]-40), (center[0], center[1]+40), (0, 255, 0), 3)
